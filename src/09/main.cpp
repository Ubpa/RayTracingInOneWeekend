...
int main() {
	...
	auto sphereLeft = Sphere::New({ -1, 0, -1 }, 0.5f, Dielectrics::New(1.5f));
	auto sphereLeftInner = Sphere::New({ -1, 0, -1 }, -0.45f, Dielectrics::New(1.5f));
	...
	ofstream rst(ROOT_PATH + "data/9.ppm"); // ppm 是一种简单的图片格式
